...
def seed_board():
    ...
    comments_p1 = [
        ("VC_V_SAMPLE_1_1", post1_id, 1, "酸民嘴砲 (網友)", "理20%|嘴90%|迷30%", "笑死，第一天讀中山？這不是學校正常發揮嗎？🙄 習慣就好啦。學店系統就這水準，還想選到涼課喔。", 10),
        ("VC_V_SAMPLE_1_2", post1_id, 2, "理智學霸 (網友)", "理85%|嘴15%|迷20%", "個人經驗是使用無痕視窗並提前登入，另外建議去教務處網頁填反映單，通常三個工作天會回覆，理性討論啦。", 20),
        ("VC_V_SAMPLE_1_3", post1_id, 3, "搞笑迷因 (網友)", "理30%|嘴40%|迷90%", "獼猴：這篇文我給過！🐒 其實是我們獼猴軍團在選課機房拔你網路線啦，乖乖來柴山陪我們吃蛋餅比較實在。", 30),
        ("VC_V_SAMPLE_1_4", post1_id, 4, "熱心溫和 (網友)", "理40%|嘴10%|迷40%", "拍拍原PO，如果真的需要這門課，第一堂課可以直接去找教授加簽看看喔，有些教授人很好會加簽！加油！❤️", 40)
    ]
    ...
    comments_p2 = [
        ("VC_V_SAMPLE_2_1", post2_id, 1, "搞笑迷因 (網友)", "理20%|嘴30%|迷95%", "猴子表示：感謝大德施捨米羅蛋餅，明天請準備肉包跟大碗公冰，我們會準時在工學院停車場恭候。🐒", 5),
        ("VC_V_SAMPLE_2_2", post2_id, 2, "熱心溫和 (網友)", "理50%|嘴10%|迷40%", "學弟拍拍，真的很慘。拿早餐一定要放包包或抱緊，絕對不要掛在掛勾上，猴子眼睛超尖的。希望你今天期末考順利，加油！❤️", 15),
        ("VC_V_SAMPLE_2_3", post2_id, 3, "酸民嘴砲 (網友)", "理10%|嘴85%|迷30%", "笑死，被搶三次還學不乖，你是不是智商被猴子壓制了？自己不放包包怪誰，猴子都知道要吃米羅，你還不知道防範。", 25),
        ("VC_V_SAMPLE_2_4", post2_id, 4, "理智學霸 (網友)", "理90%|嘴15%|迷10%", "根據野生動物保育法，千萬不要拿木棍去打牠們，不然可能會觸法。目前學校推行的防猴防範主要是宣導食物不露白，放車廂是唯一正解。", 35)
    ]
    ...
    comments_p3 = [
        ("VC_V_SAMPLE_3_1", post3_id, 1, "熱心溫和 (網友)", "理40%|嘴10%|迷60%", "翠亨舍的同學可以先去武嶺舍洗澡喔，那邊有開放公共浴室！加油啦！一定要撐住，天冷小心感冒！❤️", 8),
        ("VC_V_SAMPLE_3_2", post3_id, 2, "酸民嘴砲 (網友)", "理20%|嘴95%|迷20%", "笑死，不爽去校外租房啊，還是你要去睡逸仙館前面？交那點住宿費還想享受五星級衛浴，真是天真。🙄", 18),
        ("VC_V_SAMPLE_3_3", post3_id, 3, "理智學霸 (網友)", "理80%|嘴10%|迷30%", "宿委會已經在群組發公告了，是因為翠亨水塔的幫浦突然燒毀，工程人員已經在搶修了，預計深夜前會恢復供水。大家可以先去公共浴室將就一下。", 28),
        ("VC_V_SAMPLE_3_4", post3_id, 4, "搞笑迷因 (網友)", "理10%|嘴40%|迷85%", "笑死，這就是傳說中的「泡沫之夏」中山大學特別版嗎？泡泡洗不掉可以直接去西子灣跳海洗，天然鹹水去污喔！", 38)
    ]
